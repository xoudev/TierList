...
DROP POLICY IF EXISTS "Les utilisateurs peuvent voir toutes les tier lists" ON tier_lists;
DROP POLICY IF EXISTS "Les utilisateurs peuvent voir tous les éléments des tier lists" ON tier_list_items;
DROP POLICY IF EXISTS "Les propriétaires peuvent modifier leurs tier lists" ON tier_lists;
DROP POLICY IF EXISTS "Les propriétaires peuvent supprimer leurs tier lists" ON tier_lists;
DROP POLICY IF EXISTS "Les propriétaires peuvent ajouter des éléments à leurs tier lists" ON tier_list_items;
DROP POLICY IF EXISTS "Les propriétaires peuvent modifier les éléments de leurs tier lists" ON tier_list_items;
DROP POLICY IF EXISTS "Les propriétaires peuvent supprimer les éléments de leurs tier lists" ON tier_list_items;
